...
urlpatterns = [
    ...
    path('coach_player_attendance/', views.coach_player_attendance, name="coach_player_attendance"),
    path('coach_add_player_attendance/', views.coach_add_player_attendance, name="coach_add_player_attendance"),
