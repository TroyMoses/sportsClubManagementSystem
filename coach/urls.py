...
urlpatterns = [
    ...
    path('coach_player_attendance_session/', views.coach_player_attendance_session, name="coach_player_attendance_session"),
    path('coach_add_player_attendance_session/', views.coach_add_player_attendance_session, name="coach_add_player_attendance_session"),
